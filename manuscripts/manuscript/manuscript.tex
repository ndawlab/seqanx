...
% Can probably fill in some of the above. Specifically flesh out descriptions of symptoms. It's rather short. 
...
% might want to clean up language for clarity, but this is right. It's the "generalization of fear..." sentence that should be clarified. It's opaque.
...
% "more likely to endorse beliefs..." should also be cleaned up. Just say threat is more likely
